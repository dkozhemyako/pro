...
class CheckNameHandler implements UpdateBookHandlersInterface
{

    private const KEY_NAME = 'book-update-name';
    private const NEXT_MSG = 'Enter new year for book';
    ...
    public function handle(UpdateBookTelegramDTO $updateBookTelegramDTO, Closure $next): UpdateBookTelegramDTO
    {
        ...
        $updateBookTelegramDTO->setName(Redis::get($updateBookTelegramDTO->getSenderId() . self::KEY_NAME));
